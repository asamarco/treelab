...
export function useTreeRoots({ initialTree }: UseTreeRootsProps = {}): UseTreeRootsResult {
  ...
  return {
    ...
    uploadAttachment: async (relativePath: string, dataUri: string, fileName: string): Promise<AttachmentInfo> => {
    ...
    restoreToCommit,
    resolveConflict,
    analyzeStorage: () => currentUser ? getStorageInfo() : Promise.resolve(null as any),
    purgeStorage: () => currentUser ? purgeUnusedFiles() : Promise.resolve(null as any),
