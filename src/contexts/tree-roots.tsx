...
export function useTreeRoots({ initialTree }: UseTreeRootsProps = {}): UseTreeRootsResult {
  ...
  return {
    ...
    restoreToCommit,
    resolveConflict,
    analyzeStorage: (treeId?: string, isGlobal: boolean = false) => getStorageInfo(treeId, isGlobal),
    purgeStorage: (treeId?: string, isGlobal: boolean = false) => purgeUnusedFiles(treeId, isGlobal),
