...
export function TreeNodeContent({ node, template, isExpanded, level, onSelect, contextualParentId, overrideExpandedIds, onExpandedChange, isCompactOverride, readOnly = false, disableSelection = false }: TreeNodeContentProps) {
  ...
  return (
    <CollapsibleContent>
      <div className={cn((isMobile || isCompactView) ? "pl-0 pt-0" : "pl-6 pt-2")} onClick={(e) => e.stopPropagation()}>
        {!isCompactOverride && (
          <>
        ...
        {node.children && node.children.length > 0 && (
          <div className={cn("children-container space-y-1", (isMobile || isCompactView) ? "mt-0 pt-0" : "mt-4 pt-2")} onClick={(e) => e.stopPropagation()}>
